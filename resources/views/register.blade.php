...
<body>
    ...
    <div class="flex items-center justify-center mt-36 pr-4 pl-4">
        <div class="py-1 text-left">
            <h3 class="text-2xl mt-4 font-bold text-[#867979] text-center">Register</h3>
            <h3 class="text-base mt-2 text-slate-800 font-meduim text-center">Mohon masukkan informasi anda!
            </h3>
            <form action="">
                <div class="mt-4 sm:w-96">
                    ...
                    <a href="" id="loginAdmin"
                        ...
                        Sudah memiliki akun? <b> Silahkan Login<b></a>
                </div>
            </form>
        </div>
    </div>
